        ...
        <form class="form-horizontal">
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" id="inputTel" placeholder="文章内容">
              </div>
            </div>
          </div>
          <!-- /.box-body -->
            ...
            <div class="box-header">
              ...
              <div class="box-tools">
                  <div class="btn-group" style="margin-bottom: 5px;">
					...
					<button type="button" class="btn btn-sm text-success" onclick="javascript:location.href='article_edit.html';"><i class="fa fa-plus"></i> 新增</button>
