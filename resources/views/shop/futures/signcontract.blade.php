  	...
  	.contract .table_txta .zhang_re .zhang_img img{ height: 100%;}
		...
		<div class="shop_car order_confirm order_com mid_div">
			...
			<div class="com_title">
				...
				<a href="javascript:;" data-tel="13095555" class="lxsj R">联系商家</a>
			</div>
			<div class="contract">
				<h2>销 售 合 同</h2>
				<div class="ok_txt">
						...
						<tr>
							<td colspan="9" class="td01">								
								...
								<div class="write_div" style="padding-left: 40px;">
									...
									<input type="text" class="writ_div" style="width: 300px;" />
									<span>发出运至</span><span class="fontred">上海东路233号</span>
								</div>
								<div class="write_div" style="padding-left: 40px;">
									<span>商家承诺的价格是：</span>
									
									<input type="text" class="writ_div" style="width: 80px;" />
									<span>元/吨</span>
						...
						<tr>
							<td colspan="9" class="td01">
								<div class="write_div" style="padding-left: 40px;">
									...
									<input type="text" class="writ_div" style="width: 260px;" />
									<span>（小写：</span><input type="text" class="writ_div" style="width: 126px;" /><span>元）</span>
...
（二）如共、需双方在合同执行过程中发生争议，由双方协商解决，协商不成的，提交合同签订地的人民法院诉讼解决。</p>
					...
					<div class="write_div">
						...
						<input type="hidden" class="label_txt" />
					</div>
					<table class="table_txta">
						<tr>
							<td>
								<div class="zhang_re">
									<div>供方：天津华远兴业钢铁销售有限公司 </div>
									<div><span>代理人：</span><input type="text" class="writ_div" style="width: 200px;" /></div>
									<div class="zhang_img">
