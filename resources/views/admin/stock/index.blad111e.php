      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="/admin/stock" ><i class="fa fa-circle-o"></i> 现货列表</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="/admin/user"><i class="fa fa-circle-o"></i> 用户列表</a></li>
        ...
        <div class="col-xs-12">
          <div class="box box-info">
            <div class="box-header">
              <h3 class="box-title">现货一览</h3>

              <div class="box-tools">
                  <div class="btn-group" style="margin-bottom: 5px;">
                    <button type="button" class="btn btn-sm text-success" onclick="javascript:location.href='/admin/user/add';"><i class="fa fa-plus"></i> 新增</button>
<!--                    <button type="button" class="btn btn-sm text-warning"><i class="fa fa-archive"></i> 审核</button>-->
            ...
            <div class="box-body table-responsive">
              <table class="table table-bordered table-hover">
                ...
                <tbody>
                  ...
                  <tr>
                    <td><input type="checkbox" name="stock_id[]" value="{{ $stock->id }}"></td>
                    <td>{{ $stock->name }}</td>
                    <td>{{ $stock->price }}</td>
                    <td>{{ $stock->unit }}</td>
                    <td>{{ $stock->stock }}</td>
                    <td>{{ $stock->steelmill }}</td>
                    <td>
                      @if ($stock->type == 0)
                        <span class="label label-danger">现货</span>
                      @elseif ($stock->user_status == 9)
                        <span class="label label-danger">特卖</span>
                      @endif
                    </td>
                    ...
                    {{--<td>
                      ...
                      @elseif ($stock->user_status == 0)
                        <span class="label label-default">未激活</span>
                      @elseif ($stock->user_status == 1)
                        <span class="label label-success">已激活</span>
                      @elseif ($stock->user_status == 2)
                        <span class="label label-success">已禁言</span>
                      @endif
                     </td>--}}
                    <td>{{ Config::get('const.user_role.' . $user->role) ?: Config::get('const.user_role.user') }}</td>
                    <td>
