            ...
            <div class="box-header">
              ...
              <div class="box-tools">
                  <div class="btn-group" style="margin-bottom: 5px;">
                    <button type="button" class="btn btn-sm text-success" onclick="javascript:location.href='{{ route('admin.admin.role.add') }}';"><i class="fa fa-plus"></i> 新增</button>
            ...
            <div class="box-body table-responsive">
              <table class="table table-bordered table-hover">
                ...
                <tbody>
                  ...
                  <tr>
                    <td><input type="checkbox" name="user_id[]" value="{{ $role->id }}"></td>
                    <td>{{ $role->id }}</td>
                    <td>{{ $role->name or '' }}</td>
                    <td>{{ $role->detail }}</td>
                    ...
                    <td>
                      @if($role->id == 1)
                        超级角色
                      @else
                        <a href="{{ route('admin.admin.role.edit', ['id' => $role->id]) }}" class="btn btn-xs btn-default">
  ...
  $(function () {
    ...
    var user = new User();
      $(document).on('click', '.delete-selected', function() {
          ...
          $.post('{{ route('admin.admin.role.delete') }}', data, function(response) {
