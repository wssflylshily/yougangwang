...
class PublishBatchSMSMessage
{
    public function run()
    {
        ...
        $this->endPoint = ""; // eg. http://1234567890123456.mns.cn-shenzhen.aliyuncs.com
        $this->accessId = "YourMNSEndpoint";
        $this->accessKey = "m8vUHLn7iJIFeQMTBsX8UkYoFaIxU7";
        $this->client = new Client($this->endPoint, $this->accessId, $this->accessKey);
        /**
         * Step 2. 获取主题引用
         */
        $topicName = "SMS_61735016";
        $topic = $this->client->getTopicRef($topicName);
        /**
         * Step 3. 生成SMS消息属性
         */
        // 3.1 设置发送短信的签名（SMSSignName）和模板（SMSTemplateCode）
        $batchSmsAttributes = new BatchSmsAttributes("62415046", "优钢网");
        // 3.2 （如果在短信模板中定义了参数）指定短信模板中对应参数的值
        $batchSmsAttributes->addReceiver("18636476679", array("code" => "456"));
