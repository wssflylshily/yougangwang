      ...
      <div class="box collapsed-box">
        ...
        <form class="form-horizontal">
          <div class="box-body">
            ...
            <div class="form-group">
              <label for="inputTel" class="col-sm-2 control-label">评价用户</label>

              <div class="col-sm-10">
                <input type="text" class="form-control" id="inputTel" placeholder="评价用户">
              </div>
            </div>
          </div>
          <!-- /.box-body -->
        ...
        <div class="col-xs-12">
          <div class="box box-info">
            <div class="box-header">
              ...
              <div class="box-tools">
                  <div class="btn-group" style="margin-bottom: 5px;">
					...
					<button type="button" class="btn btn-sm text-success time-back"> 星级排序</button>
              ...
              <table class="table table-bordered table-hover">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>用户*1</td>
                    <td>2016-06-17</td>
                    <td style="color: #FF0000;" class="evaluate" data_score="4.0"></td>
                    <td>好评</td>
                  ...
                  <tr>
                    ...
                    <td>用户*1</td>
                    <td>2016-06-17</td>
                    <td style="color: #FF0000;" data_score="4" class="evaluate"></td>
                    <td>好评</td>
                  ...
                  <tr>
                    ...
                    <td style="color: #FF0000;" data_score="4" class="evaluate"></td>
                    <td>好评</td>
                    <td><span class="label label-default">已禁用</span></td>
                    <td>
                        <a href="evaluate_edit.html" class="btn btn-xs btn-default">
                           编辑
                        </a>
            ...
            <div class="box-footer clearfix" style="border: none;">
              {{--{!! page_render($evaluate_list) !!}--}}
              {!! $evaluate_list->appends(Request::query())->render() !!}
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
...
<script>
  $(function () {
  	...
  	$(".evaluate").each(function(){
  		...
  		var data_empty=5-parseInt($(this).attr("data_score"));
  		if(data_empty>0)
  		{
  		...
  		if(parseInt($(this).attr("data_score"))>0)
  		{
  			for(var i=0;i<parseInt($(this).attr("data_score"));i++)
	  		{
	  			$(this).prepend(str);
	  		}
  		}
