            ...
            <div class="box-header">
              ...
              <div class="box-tools">
                  <div class="btn-group" style="margin-bottom: 5px;">
					...
					<button type="button" class="btn btn-sm text-success" onclick="javascript:location.href='{{ route('admin.webset.steel.variety-add') }}';"><i class="fa fa-plus"></i> 添加</button>
    ...
    $(document).on('click', '.delete-selected', function() {
        ...
        $("tbody input[name='id']:checked").each(function(){
       	...
       	else
       	{
       		...
       		{
                $.post("{{ route('admin.webset.steel.variety-delete') }}",{'id':chk_value, '_token': "{{ csrf_token() }}"},function(result){
                    console.log(result);
                    //$("span").html(result);
