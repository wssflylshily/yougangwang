	            ...
	            <div class="box-header with-border">
	      		...
	      		<table class="zl_table">
	    			...
	    			<tr>
	    				...
	    				<td><input type="text" name="title" value="{{isset($info->title)?$info->title:''}}" placeholder="文章标题"></td>
	    			</tr>
	    			<tr>
			            ...
			            <textarea name="content" type="text" class="form-control" placeholder="0"  errmsg="请输入内容.."  reg="/[\S]+/"
					         id="editor" style="width:100%;height:550px;visibility:hidden;">{{isset($info->content)?$info->content:''}}
					          				      </textarea>
			           </div>
	    				</td>
	    			</tr>
                    <tr>
                        ...
                        <td>
                            是<input type="radio" name="is_show" value="1" @if($info->is_show==1) checked @endif />
                            否<input type="radio" name="is_show" value="0" @if($info->is_show==0) checked @endif />
                        </td>
                    </tr>
	    			<tr>
	    				<td align="right" valign="top">发布时间</td>
	    				<td>
	    					<input type="text" name="published_at" value="{{isset($info->created_at)?$info->created_at->format('m/d/Y'):''}}" id="datepicker" />
	    				</td>
	    			</tr>                                                                                                                                                                                                           
	    		</table>
