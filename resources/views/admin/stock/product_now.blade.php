      ...
      {{--<ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="admin/futures"><i class="fa fa-circle-o"></i> 期货管理</a></li>
        ...
        <form class="form-horizontal">
          <div class="box-body">
            <div class="select_div">
                <div>
					<select name="district" id="sheng">
						<option>选择地区</option>
                        @foreach($provinces as $sheng)
                          <option value="{{$sheng->areaId}}" >{{$sheng->areaName}}</option>
                        @endforeach
						{{--<option>华北</option>
						<option>华南</option>--}}
					</select>
            ...
            <div class="box-header">
              ...
              <div class="box-tools">
                  <div class="btn-group" style="margin-bottom: 5px;">
					...
					<button type="button" class="btn btn-sm text-danger hot-selected">一键特卖</button>
					...
					<button type="button" class="btn btn-sm text-danger delete-selected">一键删除</button>
...
<script>
  $(function () {
    ...
    //一键热卖
    $(document).on('click','.hot-selected',function(){
    	//按时间倒叙
    	user.hotSelected();
    }); 
    //一键排序
