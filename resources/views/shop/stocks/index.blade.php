...
@section('main-content')
		...
		<div class="mid_div exchange com_div">
			<form action="{{ route('shop.stocks') }}" method="get">
			...
			<div class="car_div">
				...
				<div class="div1">购买吨数 <input type="number" name="buy_number" value="1" id="number_id"></div>
...
<!--		<script src="/assets/base.js"></script>-->
		...
		<script>
			/*$("#standard").click(function () {
				...
				//alert(data);
				if (data==1){
					$(this).attr('href', "{{ route('shop.stocks', ['standard'=>-1]) }}")
				}
			})*/
