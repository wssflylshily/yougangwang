...
货到后无故拒收需支付运费</p>
			...
			<div class="futures_fb com_div" style=" width: 1131px; margin: -37px 0px 0px 69px; border-top: 1px solid #5e86e1;">
				<h2 style="padding: 20px 20px;"><span class="s01">订单号： GDYGHT120003765 </span></h2>
				<div class="list_eleven list_eleven3" style="margin-top: 0px;">
					...
					<div class="order_list" style="padding: 0px;">					
						<ul class="order_ul" style="border: none;">
							<li class="clear">
								<div class="L one single_txt">天津</div>
								...
								<div class="L seven single_txt"><span class="s_num">5</span></div>
								<div class="L eight single_txt"><span class="s_num">69</span></div>
								<div class="L nine single_txt">￥<span class="s_price">31200</span></div>
								<div class="L ten single_txt">￥<span class="s_price">1000</span></div>
							</li>
							<li class="clear">
								<div class="L one single_txt">天津</div>
								<div class="L two single_txt">无缝管</div>
							...
							<li class="final clear" >
								...
								<div style="text-align: right; width: 400px;">
									<span>合计（含运费）：</span><span class="s02">￥800.00</span>
								</div>
							</li>
						</ul>
					</div>
				...
				<div class="clear">
					<a href="/futures/produce" class="pay_btn R">确认支付</a>
