            ...
            <div class="box-header">
              ...
              <div class="box-tools">
                  <div class="btn-group" style="margin-bottom: 5px;">
					...
					<button type="button" class="btn btn-sm text-success" onclick="javascript:location.href='{{ route('admin.webset.steel.steelmill-add') }}';"><i class="fa fa-plus"></i> 添加</button>
  ...
  $(function () {
    ...
    $(document).on('click', '.delete-selected', function() {
        ...
        $("tbody input[name='id']:checked").each(function(){
       	...
       	{
       		if(confirm("您确定删除选中的钢厂吗"))
       		{
                $.post("{{ route('admin.webset.steel.steelmill-delete') }}",{'id':chk_value, '_token': "{{ csrf_token() }}"},function(result){
                    console.log(result);
                    //$("span").html(result);
