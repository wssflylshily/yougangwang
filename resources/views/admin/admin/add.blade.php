          ...
          <div class="box box-info">
            ...
            <div class="box-body">
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="email" class="form-control" id="inputEmail" required placeholder="" name="email">
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control" id="inputEmail3" required placeholder="" name="name">
                </div>
              </div>
              <div class="form-group">
...
<script>
  ...
  $("#sub_but").click(function () {
      ...
      var state_type = $('input[name="state_type"]:checked').val();
      ...
      $.ajax({
          type:"POST",
          url:"{{ route('admin.admin.add') }}",
          datatype: "json",
          data: {'_token': "{{ csrf_token() }}", 'name':name, 'email': email, 'password': password, 'role_id' :role_id, 'state' : state_type},
