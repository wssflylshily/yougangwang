	            ...
	            <div class="box-header">
	      		...
	      		<table class="zl_table">
	      		    <tr>
                        ...
                        <td><input type="text" name="name" required placeholder="输入角色名" value=""></td>
	    			</tr> 
	    			<tr>
	    				<td width="100" align="right">角色描述</td>
	    				<td><input type="text" name="detail" required placeholder="输入角色描述" value=""></td>
	    			</tr>
                    <tr>
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        @foreach($menu['menu'] as $child)
                                            <td><input type="checkbox" name="menu_id" value="{{ $child->id }}" ></td>
                                            <td>{{ $child->title }}</td>
                                        @endforeach
                                    </tr>
                                </table>
